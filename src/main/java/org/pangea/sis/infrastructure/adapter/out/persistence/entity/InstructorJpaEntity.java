...
/**
 * JPA entity representing an instructor in the persistence layer.
 * Contains infrastructure-specific annotations (JPA, Jackson, validation).
 */
@Entity
@Table(name = "instructor")
public class InstructorJpaEntity implements Serializable {
    ...
    private List<StudentJpaEntity> advisedStudents;

    // --- Constructors ---

    public InstructorJpaEntity() {}
    ...
    public void setCourses(List<CourseJpaEntity> courses) {
        this.courses = courses;
    }

    public List<StudentJpaEntity> getAdvisedStudents() {
        return advisedStudents;
    }

    public void setAdvisedStudents(List<StudentJpaEntity> advisedStudents) {
